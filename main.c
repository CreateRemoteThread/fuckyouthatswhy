...
#define PIN_WAIT_RESP PINC1

#define ASSERT_AUXREQ_HIGH PORTC |= (1 << PORTC0)
#define ASSERT_AUXREQ_LOW PORTC &= ~(1 << PORTC0)
		...
		case 0xFF:
			switch(dataBus)
			{
				...
				case 0x02:
					...
					setupSector(bios_dsk,bios_trk,bios_sec);
					break;
				case 0x03:
...
int main(void)
{
	...
	*/
	...
	// "interrupt yield" works, but needs more pins.
	// getAuxData();
